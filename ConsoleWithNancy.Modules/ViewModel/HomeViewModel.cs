...
namespace ConsoleWithNancy.Modules.ViewModel
{
    public class HomeViewModel
    {
        ...
        public class MyUserMapper : IUserMapper
        {
            ...
            static MyUserMapper()
            {
                users.Add(new Tuple<string, string, Guid>("admin", "password",
                    new Guid("55E1E49E-B7E8-4EEA-8459-7A906AC4D4C0")));
                users.Add(new Tuple<string, string, Guid>("user", "password",
                    new Guid("56E1E49E-B7E8-4EEA-8459-7A906AC4D4C1")));
            }
